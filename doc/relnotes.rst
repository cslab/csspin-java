...
.. This document contains the release notes for csspin-java. Each release is
   ...
   %Y"`.
    ...
    - Add release notes to the documentation structure (`#27 <https://code.contact.de/qs/spin/spin_java/-/issues/27>`_)
